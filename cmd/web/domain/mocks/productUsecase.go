...
func (_m *ProductUsecase) FetchByCategory(c context.Context, userID string) ([]domain.Product, error) {
...
//TODO
// FetchByName provides a mock function with given fields: c, userID
func (_m *ProductUsecase) FetchByName(c context.Context, userID string) ([]domain.Product, error) {
	ret := _m.Called(c, userID)
...
//TODO
// FetchBySKU provides a mock function with given fields: c, userID
func (_m *ProductUsecase) FetchBySKU(c context.Context, userID string) ([]domain.Product, error) {
	ret := _m.Called(c, userID)
