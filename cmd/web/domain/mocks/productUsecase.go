...
////TODO
//func (_m *ProductUsecase) FetchByCategory(c context.Context, filter string) ([]domain.Product, error) {
...
//func (_m *ProductUsecase) FetchByName(c context.Context, filter string) ([]domain.Product, error) {
//	ret := _m.Called(c, filter)
//
//	var r0 []domain.Product
//	if rf, ok := ret.Get(0).(func(context.Context, string) []domain.Product); ok {
...
//func (_m *ProductUsecase) FetchBySKU(c context.Context, filter string) ([]domain.Product, error) {
//	ret := _m.Called(c, filter)
//
//	var r0 []domain.Product
//	if rf, ok := ret.Get(0).(func(context.Context, string) []domain.Product); ok {
